...
class EditAddPlaceholoders extends StatefulWidget {
  const EditAddPlaceholoders({super.key});

  @override
  State<EditAddPlaceholoders> createState() => _EditAddPlaceholodersState();
}

class _EditAddPlaceholodersState extends State<EditAddPlaceholoders> {
  double _height = 300;
