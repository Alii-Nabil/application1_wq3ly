class UploadNewDocumentaAndgetModel {
  String? title;
  String? externalId;
  int? documentId;
  ...
  UploadNewDocumentaAndgetModel.fromJson(Map<String, dynamic> json) {
    title = json['title'];
...
class AuthOptions {
  ...
  AuthOptions({this.globalAccessAuth, this.globalActionAuth});
